        ...
        do{
            ...
            switch (building) {
                case "house" -> {
                    ...
                    Houses a12 = new Houses("N Race St", 679, 5, 4, "2,730", 3800, true, true, "December 31, 2020");
